        ...
        <div className="post border-[1px] p-4 border-color-text-lighter-grey rounded my-4 shadow-md">
            <li className="list-none flex items-center">
                ...
                <div className="flex justify-center items-center">
                    ...
                    <p className="text-sm px-2">@doejohn</p>
            ...
            <li className="list-none text-left py-2">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Eum provident quo
                voluptatem quas velit autem esse. Facere non optio quisquam ratione! Iste sint
                incidunt ab tempore optio cumque laborum temporibus.
            </li>
